...
public class Controller extends JPanel implements Runnable {
	...
	public static Font bigFont = new Font("ComicSansMS", Font.PLAIN, 25);
	 public static Font smallFont = new Font("ComicSansMS", Font.PLAIN, 19);
	...
	public void run() {
		...
		while (running) {
			...
			fps = 60.0 / (System.nanoTime() - lastTime);
			lastTime = System.nanoTime();
		}
	}
